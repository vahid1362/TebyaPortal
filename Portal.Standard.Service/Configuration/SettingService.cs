...
using Portal.Standard.Core.Configuration;
...
namespace Portal.Service.Configuration
{
    ...
    public partial class SettingService : ISettingService
    {
        ...
        {
            //cache
            return _cacheManager.Get(PortalCachingDefaults.SettingsAllCacheKey, () =>
            {
        ...
        protected virtual void SetSetting(Type type, string key, object value, int storeId = 0, bool clearCache = true)
        {
            ...
            var settingForCaching = allSettings.ContainsKey(key)
                ? allSettings[key].FirstOrDefault(x => x.StoreId == storeId)
                : null;
        ...
        public virtual void InsertSetting(Setting setting, bool clearCache = true)
        {
            ...
            //cache
            if (clearCache)
                _cacheManager.RemoveByPattern(PortalCachingDefaults.SettingsPatternCacheKey);
        ...
        /// <param name="keySelector">Key selector</param>
        /// <returns>Key</returns>
        public virtual string GetSettingKey<TSettings, T>(TSettings settings,
